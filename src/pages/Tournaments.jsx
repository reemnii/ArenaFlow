...
export default function Tournaments() {
  ...
  return (
    <section className="min-h-screen px-4 py-8 sm:px-6 lg:px-8 text-white">
          ...
          <div className="flex flex-col gap-4 lg:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/10 py-3 pl-11 pr-4 text-white outline-none placeholder:text-white/45"
              />
            </div>
            ...
            <select
              ...
              className="min-w-[180px] rounded-xl border border-white/10 bg-[#2b0f28] px-4 py-3 text-white outline-none"
            >
            ...
            {filteredTournaments.map((tournament) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="mb-5 line-clamp-3 text-sm leading-6 text-white/70">
                    {tournament.description}
                  </p>
